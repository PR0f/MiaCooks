            ...
            >
                <View key="1">
                    <ParallaxScrollView
                        ...
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 22 }]}>Makaron z twarogiem</Text>
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 20 }]}>Składniki</Text>
                        <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{ paddingLeft: 5}}>twaróg np. chudy</Text>
                            <Text style={{ marginLeft: 'auto', right: 10 }}>250 g</Text>
                        </View>
                ...
                <View key="3">
                    <ParallaxScrollView
                        ...
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 22 }]}>Makaron z twarogiem</Text>
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 16 }]}>Makaron z twarogiem i cebulką to pyszne, błyskawiczne i proste do zrobienia danie, które przez wielu moich Czytelników może być kojarzone z dzieciństwem. To bardzo elastyczny przepis, o czym przekonacie się czytając jego treść.</Text>
                    </ParallaxScrollView>
                </View>
                <View key="4">
                    <ParallaxScrollView
                ...
                <View key="6">
                    <ParallaxScrollView
                        ...
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 22 }]}>Krok 3: Całość podawaj z twarogiem</Text>
                        <Text style={[{ color: 'rgb(0, 0, 0)', fontSize: 16 }]}>Na ugotowany makaron wyłóż całą zawartość patelni, a następnie pokruszony w dłoniach twaróg (u mnie chudy, ale może być też tłustszy lub twaróg typu krajanka). Dopiero gotowe danie oprósz świeżo mielonym pieprzem i podawaj. </Text>
                    </ParallaxScrollView>
                </View>
